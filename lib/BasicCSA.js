...
ResultStream.prototype._transform = function (connection, encoding, done) {
  ...
  this._minimumTransferTimes.getTransferTime(this._earliestArrivalTimes[connection["departureStop"]],connection,this._minTransferTime,this._wheelchairAccessible, function(transferTime) {
