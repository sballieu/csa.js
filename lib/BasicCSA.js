 ...
 */
var ResultStream = function (query, client) { //TODO: , footpathsTo) {
...
ResultStream.prototype._transform = function (connection, encoding, done) {
  ...
  var transferTime = this._client.getTransferTime(this._earliestArrivalTimes[connection["departureStop"]],connection,this._minTransferTime,this._wheelchairAccessible);
